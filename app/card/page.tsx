...
// Mock Data
const topCashbacks = [
  { name: 'KB국민카드', benefit: '최대 86만원', bg: 'bg-transparent', image: 'https://urxbdqmrsfzmztkacfiv.supabase.co/storage/v1/object/public/HYESO-LAB/icons/app/card/kb-cardlogo-icon.png' },
  { name: '신한카드', benefit: '최대 74만원', bg: 'bg-transparent', image: 'https://urxbdqmrsfzmztkacfiv.supabase.co/storage/v1/object/public/HYESO-LAB/icons/app/card/shinhan-cardlogo-icon.png' },
  { name: '우리카드', benefit: '통신/렌탈 할인', bg: 'bg-transparent', image: 'https://urxbdqmrsfzmztkacfiv.supabase.co/storage/v1/object/public/HYESO-LAB/icons/app/card/woori-cardlogo-icon.png' },
  { name: '현대카드', benefit: '최대 75만원', bg: 'bg-transparent', image: 'https://urxbdqmrsfzmztkacfiv.supabase.co/storage/v1/object/public/HYESO-LAB/icons/app/card/hyundai-cardlogo-icon.png' },
  { name: '삼성카드', benefit: '최대 36.5만원', bg: 'bg-transparent', image: 'https://urxbdqmrsfzmztkacfiv.supabase.co/storage/v1/object/public/HYESO-LAB/icons/app/card/samsung-cardlogo-icon.png' },
  { name: 'NH농협카드', benefit: '최대 26.5만원', bg: 'bg-transparent', image: 'https://urxbdqmrsfzmztkacfiv.supabase.co/storage/v1/object/public/HYESO-LAB/icons/app/card/nh-cardlogo-icon.png' },
  { name: 'KB국민(체크)', benefit: '최대 3만원', bg: 'bg-transparent', image: 'https://urxbdqmrsfzmztkacfiv.supabase.co/storage/v1/object/public/HYESO-LAB/icons/app/card/kb_heartyouping_check-cardlogo-icon.png' },
];

const cardCompanies = [
  { name: '신한카드', color: 'text-[#0046ff]', logo: 'https://urxbdqmrsfzmztkacfiv.supabase.co/storage/v1/object/public/HYESO-LAB/logos/app/card/shinhan-card-logo.png' },
  { name: '현대카드', color: 'text-black', logo: 'https://urxbdqmrsfzmztkacfiv.supabase.co/storage/v1/object/public/HYESO-LAB/logos/app/card/hyundai-card-logo.png' },
  { name: '롯데카드', color: 'text-[#ed1c24]', logo: 'https://urxbdqmrsfzmztkacfiv.supabase.co/storage/v1/object/public/HYESO-LAB/logos/app/card/lotte-card-logo.png' },
