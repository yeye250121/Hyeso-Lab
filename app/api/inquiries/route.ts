...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabaseAdmin
      .from('inquiries')
      .select('id, phone_number, install_location, install_count, marketer_code, status, submitted_at, created_at, inquiry_type, reservation_date, reservation_time_slot, outdoor_count, indoor_count, address, address_detail, zonecode, documents, documents_submitted, referrer_url, landing_template, landing_subtype', { count: 'exact' })
